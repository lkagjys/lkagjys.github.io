...
var style_2017_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = "";
    size = 0;
    var labelFont = "font: '10px, sans-serif'";
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(119,120,209,1.0)'})}),
...
function update() {
    ...
    var features = lyr_2017_0.getSource().getFeatures();
