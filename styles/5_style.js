...
var style__5 = function(feature, resolution){
    ...
    var labelText = "";
    size = 0;
    var labelFont = "font: '20.8px \'Gulim\', sans-serif'";
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1}), fill: new ol.style.Fill({color: 'rgba(137,32,58,0.0)'}),
...
function update() {
    ...
    var features = lyr__5.getSource().getFeatures();
