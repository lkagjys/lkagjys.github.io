...
var style__13 = function(feature, resolution){
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(204,65,106,1.0)'}),
...
function update() {
    ...
    var features = lyr__13.getSource().getFeatures();
